...
const Hero = () => {
    return (
        <div className='pl-10 pr-10 pb-10 text-white'>
            ...
            <div className=' text-4xl pt-20 text-center hover: origin-top transition-all  duration-1000 mb-32 '>Here we are all about <br></br> <i className='text-8xl text-gray-500 '>coding our way up</i> </div>
